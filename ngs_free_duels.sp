...
{	
	...
	cvarEnabled 		= CreateConVar("duel_enabled", 			"1", 	"Enable or disable Free Duels ?", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	c_Tag		 		= CreateConVar("duel_tag", 				"1", 	"Add 'duels' tags", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	c_EnableClass		= CreateConVar("duel_class", 			"1", 	"0 = disable class restriction duel, 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	c_EnableType[1]		= CreateConVar("duel_type1", 			"1",	"0 = disable `normal` duel, 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	c_EnableType[2]		= CreateConVar("duel_type2", 			"1", 	"0 = disable `time left` duel, 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	c_EnableType[3]		= CreateConVar("duel_type3", 			"1",	"0 = disable `amount of kills` duel, 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	c_EnableGodMod		= CreateConVar("duel_godmod", 			"1", 	"0 = disable challenger godmod, 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	c_EnableHeadShot	= CreateConVar("duel_headshot", 		"1", 	"0 = disable head shot only (sniper), 1 = enable", FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
bool StartReadingFromTable()
{
	...
	int MaxPlayers[TFClassType + view_as<TFClassType>(1)], breakpoint, iStart, iEnd, i, view_as<TFTeam>(a);
