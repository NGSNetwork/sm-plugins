...
public void OnLibraryAdded(const char[] name) { if (StrEqual(name, "connect")) connectExists = true; }

public void OnLibraryRemoved(const char[] name) { if (StrEqual(name, "connect")) connectExists = false; }
...
public Action Command_Say(int client, int args)
{
	...
	{
		if (connectExists && BaseComm_IsClientGagged(client))
		{
