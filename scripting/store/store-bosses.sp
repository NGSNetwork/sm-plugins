...
public Plugin myinfo = {
	name = "[Store] Spawn Bosses",
	author = "WhiteThunder / TheXeon",
...
public OnPluginStart() {
	Store_RegisterItemType("bosses", OnBossesUse);
...
public Store_ItemUseAction:OnBossesUse(client, itemId, bool:equipped)
{
