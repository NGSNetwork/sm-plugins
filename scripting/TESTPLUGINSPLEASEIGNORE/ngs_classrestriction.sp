...
public Plugin myinfo = {
	name        = "[NGS] TF2 Class Restrictions",
	author      = "Tsunami / TheXeon",
...
{
	CreateConVar("sm_classrestrict_version", PLUGIN_VERSION, "Restrict classes in TF2.", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
