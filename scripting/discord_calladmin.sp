...
#define REPORT_MSG "{\"username\":\"{BOTNAME}\",\"content\":\"<{MENTION}>\",\"attachments\":[{\"color\":\"{COLOR}\",\"title\":\"{HOSTNAME} (steam://connect/{SERVER_IP}:{SERVER_PORT}){REFER_ID}\",\"fields\":[{\"title\":\"Reporter\",\"value\":\"{REDACTED} ({REPORTER_ID})\",\"short\":true},{\"title\":\"Reason\",\"value\":\"{REASON}\",\"short\":true},{\"title\":\"Target\",\"value\":\"{TARGET_NAME} ({TARGET_ID})\",\"short\":true},{\"title\":\"Report ID\",\"value\":\"{REPORT_ID}\",\"short\":true}]}]}"
#define HANDLED_MSG "{\"username\":\"{BOTNAME}\",\"content\":\"{MSG}\",\"attachments\":[{\"color\":\"{COLOR}\",\"title\":\"{HOSTNAME} (steam://connect/{SERVER_IP}:{SERVER_PORT})\",\"fields\":[{\"title\":\"Admin\",\"value\":\"{ADMIN}\",\"short\":false,\"short\":true},{\"title\":\"Report ID\",\"value\":\"{REPORT_ID}\",\"short\":true}]}]}"
...
public void OnPluginStart()
{
	...
	g_cMention = CreateConVar("discord_calladmin_mention", "@&287372553415032833", "This allows you to mention reports, leave blank to disable.");
