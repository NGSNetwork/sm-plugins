...
*
* Files:
* addons/sourcemod/plugins/ngs_webshortcuts.smx
*
* Dependencies:
* sourcemod.inc, steamtools.inc, advanced_motd.inc,
* morecolors.inc, ngsutils.inc, ngsupdater.inc
*/
...
public void LibraryRemoved(const char[] sLibrary)
{
